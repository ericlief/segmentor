    ...
    def shift_boundary(self):
        ...
        for word in ambig:
            ...
            if has_shift and is_valid and self.valid_shift(new_morphs):
                ...
                self.all_words[adj_word] = word_count
        ...
        #
                    ...
                    # if not new_m1:
                    #     if new_m2 not in self.unknown:
                    #         new_morphs.append(new_m2)
                    #         continue
                    #
                    # elif not new_m2:
                    #     if new_m1 not in self.unknown:
                    #         new_morphs.append(new_m1)
                    #         continue
                    #
                    # # If both morphs are known, keep both and continue
                    # elif m1 not in self.unknown and m2 not in self.unknown:
                    #     new_morphs.extend([m1, m2])
                    #     continue

                    # Check if stems exist for this cut
                #     remaining_m = []
                #     for j in range(i + 1, n)
                #         morphs[j]
                #
